...
class Controller{
    ...
    var barSEMButton = ToggleButton("Bar(Enhanced)")
    var pieButton = ToggleButton("Pie")
    var scatterButton = ToggleButton("Scatter")
    val graphSelector = HBox(lineButton, barButton, barSEMButton, pieButton, scatterButton)
    val toolbarHeight = 20.0
    val buttonWidth = 65.0
    ...
    fun createController(): BorderPane {
        ...
        barSEMButton.prefWidth = buttonWidth + 50
        pieButton.prefWidth = buttonWidth
        createButton.prefWidth = buttonWidth
        scatterButton.prefWidth = buttonWidth
        ...
        lineButton.onMouseClicked = EventHandler {
            ...
            scatterButton.isSelected = false
        }
        ...
        barSEMButton.onMouseClicked = EventHandler {
            model?.changeGraphType(datasetChoice.selectionModel.selectedItem, "Bar(Enhanced)")
            lineButton.isSelected = false
            barButton.isSelected = false
            pieButton.isSelected = false
            scatterButton.isSelected = false
        ...
        scatterButton.onMouseClicked = EventHandler {
            model?.changeGraphType(datasetChoice.selectionModel.selectedItem, "Scatter")
            lineButton.isSelected = false
            barButton.isSelected = false
            barSEMButton.isSelected = false
            pieButton.isSelected = false
